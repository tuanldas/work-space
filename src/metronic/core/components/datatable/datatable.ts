...
import KTComponents from '../../index.ts';
...
export class KTDataTable<T extends KTDataTableDataInterface> extends KTComponent implements KTDataTableInterface {
    ...
    private _calculatePageRange(currentPage: number, totalPages: number, maxButtons: number): {
        start: number,
        end: number
    } {
     ...
     * @returns {void}
     */
    protected _checkboxToggle(_event?: Event): void {
     ...
     * @returns {void}
     */
    protected _checkboxUpdate(_event?: Event): void {
        let checked = 0;
